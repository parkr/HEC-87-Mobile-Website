...
<head>
	...
	<link rel="stylesheet" href="<?php echo full_url(); ?>/css/application.css" type="text/css" media="screen" charset="utf-8">
...
<body>
	<div data-role="page" data-theme="a">
		...
		<div data-role="content">
			<?php if($this->Session->flash() != ""): ?><div data-role="header">
				<?php echo $this->Session->flash(); ?>
			</div><?php endif; ?>
			<?php echo $content_for_layout; ?>
		</div>
		<div data-role="footer">
			<h4>&copy; 2012 Hotel Ezra Cornell. <a href="/contact">Contact Us</a></h4>
		</div><!-- /footer -->
	</div>
